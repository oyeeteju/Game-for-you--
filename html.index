...
<head>
  <meta charset="utf-8" />
  <title>Something For You v5</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1" />
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" /><link rel="stylesheet" href=""><script src="https://unpkg.com/typeit@8.7.0/dist/index.umd.js"></script>
...
<style>
  @import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@400;700&display=swap');
    ...
    #bodyblur{opacity:.1;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.5);transition:all 1s ease;} 
    ...
    .sembunyi, #teksAkhiran, #teksLoop, #emojiTeksLoop{display: none !important;}
    ...
    .stiker img{width:90px;height:90px;box-shadow: 0 4px 30px rgba(255, 255, 255, 0.3);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);background: rgba(255, 255, 255, .3);border: 1px solid rgba(255, 255, 255, 0.3);border-radius: 50%;padding:10px;}
    ...
    .main-card{margin-top:-10px;display:flex;flex-direction:column;align-items:center;}
	...
	.card{font-family:Arial,sans-serif;width:40px;height:40px;background-color:rgba(255,255,255,.5);display:flex;align-items:center;justify-content:center;font-size:.5em;/*cursor:pointer;*/border-radius:8px;transform:scale(0);}
	.card.flipped{font-size:1.2em;background-color:rgba(255,255,255,.3);color:#2c3e50;transition:all .5s ease}
	.hideOut {transform: scale(0) !important;opacity: 0;transition: all 0.7s ease !important;}
	.pesanAfter{display:none;font-size:2em;margin-top:20px;color:#e74c3c;}
	@keyframes appear{to{transform:scale(1);}}
	.start-button{padding:10px 20px;font-size:1em;margin-top:20px;cursor:pointer;background-color:#3498db;color:white;border:none;border-radius:5px;}
...
<body>
  ...
  <audio src="" id="linkmp3" class="sembunyi"></audio>
    ...
    <div class="overlay">
    <div class="loading-message">Hi there!<br>Please wait a moment..</div>
     <div id="loveIn" class="blocklove"></div>
   </div>
   
   <div id="bodyblur">
     <img src="./assets/pict.jpg" id="wallpaper"/>
     <div id="thisblur"></div>
   </div>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <h1 id="teks1" class="scale0 quicksand" style="font-size: 22px;">Hellooo You 🫢<br><br> >>>></h1>
            </div>
            ...
            <div class="swiper-slide">
                ...
                <h1 id="teks2" class="scale0 quicksand" style="font-size: 18px;">I have something<br>for youuu 😝<br><br> >>>></h1>
            </div>

            <div class="swiper-slide">
                <div class="main-card">
                  <h1 id="teks3" class="scale0 quicksand" style="font-size: 18px;">Try to finish<br><i style="color:pink">this Memory Game</i>! 😆</h1>
                ...
                <div id="stiker4" class="abs scale0 stiker" style="margin-top:50px">
                    ...
                    <img id="stikerAkhir100" class="sembunyi" src="./assets/emawh.gif" />
                </div>
                <div id="scroll-container" class="blocktext scale0 abs">
                    <h1 id="teks4" class="quicksand" style="font-size: 17px;font-weight:400"><b style="font-size:19px;font-weight:700;">Wow, you're so smart! 😆</b><br><br><br>Wait a moment 😋</h1>
                    <h1 id="teksLoop">I Love You</h1>
                    <h1 id="emojiTeksLoop">❤️</h1>
                    <h1 id="teksAkhiran"><b>Love you my dearest</b>,<br>the sweetest, the funniest, the cutest<br><b>stay healthy, my love 🫣💐</b></h1>
                </div>
            </div>
...
initeks = `<b style="font-size:19px;font-weight:700;">Wow, you're so smart! 😆</b><br><br><br>Wait a moment 😋`;
teks4.innerHTML = "";
function katanimasi(){
        teks4.innerHTML = "";
        new TypeIt("#teks4", {
    ...
    setTimeout(function() {
        const intervalId = setInterval(() => {
            if (percent < 9999) {
                ...
                teksLove.innerHTML = `<b>I Love You ${percent}% ${randomEmoji}</b>`;
            } else {
                clearInterval(intervalId);
                percent = 9999;
                const randomEmoji = loveEmojis[Math.floor(Math.random() * loveEmojis.length)];
                teksLove.innerHTML = `<b>I Love You More<br>Than <span style='color:yellow'>${percent}%</span> 🫣💐</b>`;
...
function katanimasi2(){
	...
	new TypeIt("#teks4", {
    strings: [
        "<span style='font-size:17px;line-height:1.5em'>I just know<br>you don't miss me 😡🫵</span>",
        "<span style='font-size:17px;line-height:1.5em'><br><b>But actually... 🫠</b></span>"
    ],
    startDelay: 10,
    speed: 25,
    cursor: true,
...
function katanimasi3(){
    teks4.innerHTML = "";
    let kangenPercentage = 10; // Start from 10%
    var vteksLoop = "I Love You";
    var vemojiTeksLoop = "❤️";
...
function katanimasi4(){
	var initeksAkhir = `<b>Love you my dearest</b>,<br>the sweetest, the funniest, the cutest<br><b>stay healthy, my love 🫣💐</b>`;
	new TypeIt("#teksLove", {
...
document.getElementById("loveIn").onclick = function() {
    if (sudahKlik) {
        ...
        sudahKlik = true; // Mark button as clicked
        document.getElementById('loveIn').innerHTML = '<style>.lovein svg{animation:none;stroke:#ff0000;stroke-width:1.3;fill:none;width:35px;height:35px}</style><label class="lovein"><svg class="line" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g transform="translate(2.550170, 3.550158)"><path d="M0.371729633,8.89614246 C-0.701270367,5.54614246 0.553729633,1.38114246 4.07072963,0.249142462 C5.92072963,-0.347857538 8.20372963,0.150142462 9.50072963,1.93914246 C10.7237296,0.0841424625 13.0727296,-0.343857538 14.9207296,0.249142462 C18.4367296,1.38114246 19.6987296,5.54614246 18.6267296,8.89614246 C16.9567296,14.2061425 11.1297296,16.9721425 9.50072963,16.9721425 C7.87272963,16.9721425 2.09772963,14.2681425 0.371729633,8.89614246 Z"></path><path d="M13.23843,4.013842 C14.44543,4.137842 15.20043,5.094842 15.15543,6.435842"></path></g></svg></label><p id="ket">Tap the LOVE!</p>';
    }
}
